...
export const FREE_TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: 'Дашборд',
    body: 'Главный экран дня: привычки, задачи и цели. Сюда возвращайся, чтобы понять, что важно сейчас.',
    cta: 'Далее',
    action: 'next',
  },
  {
    ...
    target: 'nav-desktop',
    title: 'Рабочий стол',
    body: 'Виджеты и мудборд — визуальная доска рядом с трекером. Можно вынести цели и привычки стикерами.',
    cta: 'Перейти',
    action: 'go',
  },
  {
